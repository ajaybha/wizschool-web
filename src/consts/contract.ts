...
export const collectionContractConst = import.meta.env.VITE_COLLECTION_CONTRACT_ADDR || "";
export const saleMinterContractConst = import.meta.env.VITE_SALEMINTER_CONTRACT_ADDR ||"";
